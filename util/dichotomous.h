...
/**
 * @brief Implementation of the dichotomous method to solve a non-linear equations given two bounds.
*/
...
/**
 * @brief Implementation of the multivariate dichotomous method to solve a non-linear equations given the two initial parameters corresponding to the bound with
*/
...
/**
 * @brief Implementation of the secant method to solve a non-linear equations given the two initial parameters corresponding to the bound with 
...
/**
 * @brief In the loader, the memory of param0 and param1 is already allocated and it returns a (double *) with eval0 and eval1.
*/
